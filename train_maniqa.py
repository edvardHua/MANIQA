...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        # KONIQ-10K
        "koniq10k_path": "/home/zihua/data_warehouse/low_quality/iqa_0606/image",
        "koniq10k_label": "/home/zihua/data_warehouse/low_quality/iqa_0606/label.txt",
        ...
        "crop_size": 384,
        "prob_aug": 0.7,
        "aug_type": "default",  # default or custom
    ...
    if config.aug_type == "default":
        tfs = transforms.Compose([RandCrop(patch_size=config.crop_size),
                                  Normalize(0.5, 0.5),
                                  RandHorizontalFlip(prob_aug=config.prob_aug),
                                  ToTensor()])
    elif config.aug_type == "custom":
        # 这里传入的是 dict，而不是 image，直接使用 transforms 会报错
